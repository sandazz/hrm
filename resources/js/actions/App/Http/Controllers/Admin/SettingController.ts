...
const SettingController = { index, updateCompany, updatePayroll, updateFingerprint, storeShift, updateShift, destroyShift, storeLeaveType, updateLeaveType, destroyLeaveType }
